...
class Form
{
    ...
    */
    ...
    /**
    * Returns value if the given value is LESS THAN (inclusive) the given parameter letters long
    */
    ...
    /**
    * Returns value if the given value is GREATER THAN (inclusive) the given parameter letters long
    */
